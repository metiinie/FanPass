            ...
            <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-[#E5E7EB] focus:border-[#1A7A4A] focus:outline-none transition-colors"
                  />
                  {formData.coverImage && !formData.coverImage.startsWith("https://images.unsplash.com") && (
              ...
              <div className="pt-6 flex justify-end">
                <button
                  type="button"
                  onClick={() => setStep(2)}
                  disabled={!formData.title || !formData.venue || !formData.date || !formData.time || !formData.city}
